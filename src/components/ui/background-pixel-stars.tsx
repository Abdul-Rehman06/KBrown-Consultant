...
// 16-bit color palette (reduced color options, slightly tinted gold for brand)
const STAR_COLORS = [
  "#FFFFFF", // White
  "#FFFFAA", // Light yellow
  "#F2C96D", // Light gold
  "#D4AF37", // Primary gold
  "#AAAAFF", // Light blue (for contrast)
] as const;
        ...
        if (shootingStarsRef.current.length) {
          ...
          shootingStarsRef.current.forEach((star) => {
            ...
            star.trail.forEach((point) => {
              ...
              // Tinting trail slightly gold for brand
              ctx.fillStyle = `rgba(212, 175, 55, ${point.opacity})`;
