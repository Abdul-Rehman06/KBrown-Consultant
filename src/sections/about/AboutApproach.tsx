...
const steps = [
  {
    ...
    description: 'We begin by learning about your objectives, challenges, and financial priorities.'
  },
  {
    number: '02',
    title: 'Develop a Personalized Strategy',
    description: 'Based on your goals, we provide educational guidance and practical recommendations tailored to your situation.'
  },
  {
    number: '03',
    title: 'Support Your Journey',
    description: 'We continue providing resources and consultations to help you stay informed and confident as your financial journey evolves.'
  }
];
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-white mb-4">
            Our <span className="text-gold italic">Approach</span>
          </h2>
        </motion.div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className={`relative flex flex-col md:flex-row items-start md:items-center ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  >
                    <div className="text-gold font-mono text-xl tracking-widest mb-2 opacity-50">
                      {step.number}
                    </div>
