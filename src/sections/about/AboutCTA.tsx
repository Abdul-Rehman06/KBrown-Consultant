  ...
  return (
    <section className="py-32 relative overflow-hidden bg-gold">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        >
          Let's Build Your <span className="italic text-white drop-shadow-md">Financial Confidence</span> Together
        </motion.h2>
        ...
        >
          Whether you're exploring funding opportunities, expanding your financial knowledge, or looking for personalized guidance, our team is here to help you take the next step with clarity and confidence.
        </motion.p>
        ...
        >
          <Link to="/book-consultation" className="relative overflow-hidden bg-dark text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95 w-full sm:w-auto flex items-center justify-center group">
            Book a Consultation
