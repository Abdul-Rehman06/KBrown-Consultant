    ...
    <section className="pt-32 pb-20 relative overflow-hidden bg-[#0B1523]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p>
              Whether you have questions about our services, want to schedule a consultation, or are looking for educational resources, we're here to help. Reach out to our team, and we'll be happy to guide you in the right direction.
            </p>
