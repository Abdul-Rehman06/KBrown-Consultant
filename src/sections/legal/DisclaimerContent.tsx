    ...
    <section className="py-20 relative bg-[#0B1523]">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p>
            The information provided on the KBrown Consultant Group LLC website ("Website") is intended solely for general informational and educational purposes. By accessing or using this Website, you acknowledge and agree to the terms of this Disclaimer.
          </p>
          ...
          <p>
            The information provided by KBrown Consultant Group LLC is not a substitute for advice from licensed attorneys, certified public accountants, financial advisors, tax professionals, lenders, or other qualified professionals.
          </p>
          <p>
          ...
          <p>KBrown Consultant Group LLC does not guarantee:</p>
          ...
          <p>
            These third-party services operate independently of KBrown Consultant Group LLC.
          </p>
          <p>
          ...
          <p>
            Consultations offered through KBrown Consultant Group LLC are intended to provide educational information, general guidance, and discussion based on the information voluntarily provided by the client.
          </p>
          <p>
          ...
          <p>
            Accordingly, KBrown Consultant Group LLC makes no representations or warranties regarding the completeness, accuracy, reliability, or timeliness of the information presented on this Website.
          </p>
          ...
          <p>
            To the fullest extent permitted by law, KBrown Consultant Group LLC shall not be responsible for any direct, indirect, incidental, consequential, special, or punitive damages resulting from:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-white/70">
          ...
          <p>
            KBrown Consultant Group LLC assumes no responsibility for the content, accuracy, availability, or privacy practices of external websites.
          </p>
          ...
          <div className="my-12 p-8 rounded-2xl bg-[#D4AF37]/10 border border-[#D4AF37]/20">
            ...
            <p className="text-white/90">
              KBrown Consultant Group LLC is committed to providing educational resources, professional guidance, and informational content designed to help individuals and businesses better understand financial topics.
            </p>
          ...
          <p>
            KBrown Consultant Group LLC reserves the right to update or modify this Disclaimer at any time without prior notice.
          </p>
          <p>
