    ...
    <section className="py-24 relative overflow-hidden bg-[#D4AF37]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            Let's Start Your <span className="text-white drop-shadow-md">Journey</span>
          </motion.h2>
          ...
          >
            <p>
              Whether you're exploring funding opportunities, looking to expand your financial knowledge, or simply want to speak with a professional, we're here to help.
            </p>
            <p>
              Schedule a personalized consultation and discover how education, strategy, and thoughtful guidance can help you move forward with confidence.
            </p>
          </motion.div>
        ...
        {/* Footer Disclaimer Specific to Testimonials/Success Stories */}
        <motion.div
          initial={{ opacity: 0 }}
