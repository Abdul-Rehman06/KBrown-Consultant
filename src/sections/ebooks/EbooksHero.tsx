    ...
    <section className="pt-32 pb-20 relative overflow-hidden bg-[#0B1523]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Knowledge That Helps You <span className="text-[#D4AF37]">Move Forward</span>
          </motion.h1>
          ...
          >
            <p>
              Explore our growing collection of professionally designed eBooks created to help individuals and business owners better understand funding, financial planning, credit education, and business growth.
            </p>
            <p>
              Whether you're just beginning your journey or looking to deepen your understanding, our eBooks are designed to provide practical knowledge you can apply with confidence.
            </p>
          </motion.div>
        </div>
      </div>
